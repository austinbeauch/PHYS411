...
disp("2017 confidence interval: " + conf_2017);
disp("2018 confidence interval: " + conf_2018);
...
disp("2017 confidence interval: " + conf_2017_min);
disp("2018 confidence interval: " + conf_2018_min);
